        ...
        var s = {
            getCaret: function () {
                var t, n = 0,
                    ...
                    o = a.selectionStart;
                return r && !~navigator.appVersion.indexOf("MSIE 10") ? (a.focus(), t = r.createRange(), t.moveStart("character", -a.value.length), n = t.text.length) : (o || "0" === o) && (n = o), n
            },
            setCaret: function (t) {
                var n, a = e.get(0);
            ...
            events: function () {
                e.bind("keydown.mask", function () {
                    r = s.val()
                }), e.bind("keyup.mask", s.behaviour), e.bind("paste.mask", function () {
                    setTimeout(function () {
                        e.keydown().keyup()
                    }, 100)
                })
            ...
            destroyEvents: function () {
                e.unbind("keydown.mask keyup.mask paste.mask")
            },
            val: function (t) {
                var n = e.is("input");
            ...
            behaviour: function (e) {
                ...
                if (-1 === t.inArray(n, o.byPassKeys)) {
                    ...
                    r < s.val().length && (a = !0);
                    var i = s.getMasked();
                    return i !== s.val() && s.val(i), !a || 65 === n && e.ctrlKey || s.setCaret(r), s.callbacks(e)
                }
            },
            getMasked: function (t) {
                var e, r, i = [],
                    ...
                    d = "push",
                    g = -1;
                for (a.reverse ? (d = "unshift", h = -1, e = 0, u = l - 1, v = f - 1, r = function () {
                    return u > -1 && v > -1
                }) : (e = l - 1, r = function () {
                    return l > u && f > v
                }); r();) {
                    var m = n.charAt(u),
                        k = c.charAt(v),
                        p = o.translation[m];
                    p ? (k.match(p.pattern) ? (i[d](k), p.recursive && (-1 === g ? g = u : u === e && (u = g - h), e === g && (u -= h)), u += h) : p.optional && (u += h, v -= h), v += h) : (t || i[d](m), k === m && (v += h), u += h)
                }
                var y = n.charAt(e);
                return l !== f + 1 || o.translation[y] || i.push(y), i.join("")
            },
...
$(document).ready(function () {
    ...
    $(".pomodoro-region-list a").on('click', function () {
        ...
        if ($(this).hasClass("city_change_type2")) {	
            ...
            $.cookie('change_city_mode', '' + change_city_mode + '', {
                expires: 31
            });
...
function map_label_close(label){
label.closest(".ym_my_baloon").removeClass("active");
label.closest(".places_wrap").removeClass("open");
}
